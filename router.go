...
func (t tRoute) Any(s2 string, handler Handler, middleware ...Middleware) {
    panic("implement me")
}

func (t tRoute) GET(path string, handler Handler, middleware ...Middleware) {
    t.tree.addRoute(path, handler, middleware...)
}
...
func (t tRoute) DELETE(s2 string, handler Handler, middleware ...Middleware) {
    panic("implement me")
}

func (t tRoute) PATCH(s2 string, handler Handler, middleware ...Middleware) {
    panic("implement me")
}

func (t tRoute) PUT(s2 string, handler Handler, middleware ...Middleware) {
    panic("implement me")
}
...
func (t tRoute) Find(path string) *node {
    if node, err := t.tree.find(path); err == nil {
        return node
    }
    return nil
}
